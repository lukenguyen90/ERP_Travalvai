			...
			<ul>
				...
				<li>
					...
					<ul>
						...
						<li>
							<a href="/index.cfm/project.project-list">#getResource('projectlist')#</a>
						</li>
						<li>
				...
				<li>
					...
					<ul>
						...
						<li>
							<a href="/index.cfm/shipment.box-list">#getResource('boxList')#</a>
						</li>
					</ul>
				</li>
				...
				<li>
					...
					<ul>
						...
						<li>
							<a id="liDashboard"  title="Dashboard" ><span class="menu-item-parent">#getResource('order')#</span></a>
							<ul>
								<!--- <li>
									<a href="/index.cfm/order.basicdata-condition.cfm">Condition</a>
								</li>
								<li>
									<a href="/index.cfm/order.basicdata-status.cfm">Status</a>
								</li>
								<li>
									<a href="/index.cfm/order.basicdata-ordertype.cfm">Order Type</a>
								</li> --->
								<li>
									<a href="/index.cfm/order.basicdata-payment.cfm">Payment</a>
								</li>
							</ul>
						</li>
					</ul>
