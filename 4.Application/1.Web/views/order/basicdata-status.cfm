...
<cfoutput>	
<div id="status-list-ctrl" class="" ng-app="order" ng-controller="StatusListCtrl as vmStatusList" ng-init="vmStatusList.init('#application.userType#', #application.userTypeId#)">	
	<div class="col-md-12">
       
        <div ng-include="vmStatusList.tplStatusList">
        </div>
...
<!--condition-list-->
<script src="/views/order/client/basic-data/status/status.service.js?v=#application.version#"></script>
<script src="/views/order/client/basic-data/status/status-list.ctrl.js?v=#application.version#"></script>
<!--/condition-list-->
