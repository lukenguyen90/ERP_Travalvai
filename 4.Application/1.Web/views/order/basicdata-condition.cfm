...
<cfoutput>	
<div id="condition-list-ctrl" class="" ng-app="order" ng-controller="ConditionListCtrl as vmConditionList" ng-init="vmConditionList.init('#application.userType#', #application.userTypeId#)">	
	<div class="col-md-12">
       
        <div ng-include="vmConditionList.tplConditionList">
        </div>
...
<!--condition-list-->
<script src="/views/order/client/basic-data/condition/condition.service.js?v=#application.version#"></script>
<script src="/views/order/client/basic-data/condition/condition-list.ctrl.js?v=#application.version#"></script>
<!--/condition-list-->
