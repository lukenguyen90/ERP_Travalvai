(function() {
    ...
    function lineCustomerCtrl($q, $scope, $filter, $http, $compile, DTOptionsBuilder, DTColumnBuilder, $window, $timeout, $controller, $resource, orderListService) {
        var vm = this;
        ...
        function renderpendent(data, type, full, meta) {
            return '<span style="minheight:50px;">' + full.ord_ag_pendent + '</span>';
