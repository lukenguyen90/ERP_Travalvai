(function() {
    ...
    function lineZoneCtrl($q, $scope, $filter, $http, $compile, DTOptionsBuilder, DTColumnBuilder, $window, $timeout, $controller, $resource, orderListService) {
        var vm = this;
        ...
        function renderCustomer(data, type, full, meta) {
            ...
            return '<span style="minheight:50px;">' + data.id_customer + " - " + data.cs_name +
                '</span><hr><span style="minheight:50px;">' + data.ag_code + " - " + data.ag_description + '</span>';
        }
