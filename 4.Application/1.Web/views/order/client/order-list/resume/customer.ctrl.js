(function() {
    ...
    angular
        .module('order.ctrls')
        .controller("ResumeCustomerCtrl", resumeCustomerCtrl);

    function resumeCustomerCtrl($q, $scope, $filter, $http, $compile, DTOptionsBuilder, DTColumnBuilder, $window, $timeout, $controller, $resource, orderListService) {
        var vm = this;
        ...
        function loadDatatable() {
            ...
            vm.columns = [
                ...
                DTColumnBuilder.newColumn('ord_ag_del_date').withTitle('AGENT DELIVERY DATE').withClass("text-center"), //7              
