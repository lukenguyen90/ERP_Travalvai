(function() {
    ...
    angular
        .module('order.ctrls')
        .controller("ConditionListCtrl", conditionListCtrl);

    function conditionListCtrl($state, $q,
        $scope, $filter, $http,
        $compile, DTOptionsBuilder, DTColumnBuilder, $window, $timeout,
        $controller, $resource, conditionService) {
        ...
        vm.init = init;
        vm.initCondition = initCondition;
        vm.condition = null;
        ...
        function initCondition() {
          ...
          function loadDatatable() {
            ...
            vm.options = DTOptionsBuilder.fromFnPromise(function() {
                    ...
                    return conditionService.getListConditions();
            ...
            vm.columns = [
                ...
                DTColumnBuilder.newColumn('id_order_condition').withTitle('ID').withClass("text-center"), //0
                DTColumnBuilder.newColumn('oc_description').withTitle('DESCRIPTION'), //1
        ...
        function showConditionList() {
            ...
            vm.tplConditionList = "../../views/order/client/basic-data/condition/views/condition-list.view.html";
        }
