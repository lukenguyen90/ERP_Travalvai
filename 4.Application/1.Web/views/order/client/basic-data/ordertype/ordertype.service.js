(function() {
    ...
    angular.module('order.services').factory('ordertypeService', ordertypeService);

    function ordertypeService($q, baseService) {

        var userType = { Employee: 0, Company: 1, Private: 2 };

        return {
            getUserLevel: getUserLevel,
            getListOrderTypes: getListOrderTypes,
        ...
        function getListOrderTypes() {
            return new Promise(function(resolve, reject) {
                baseService.makeRequest("getListOrderTypes").then(function(data) {
                    var result = [];
