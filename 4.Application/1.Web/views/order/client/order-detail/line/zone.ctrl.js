(function() {
    ...
    angular
        .module('order.ctrls')
        .controller("LineZoneCtrl", lineZoneCtrl);

    function lineZoneCtrl($scope, $filter, $http, $compile, DTOptionsBuilder, DTColumnBuilder, $window, $timeout, $controller, $resource, orderDetailService) {
        var vm = this;
