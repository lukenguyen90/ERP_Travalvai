(function() {
    ...
    function datatableCtrl(shipmentDetailService) {
        ...
        function getOptions(DTOptionsBuilder, from, to) {
            var options = DTOptionsBuilder.fromFnPromise(function() {
                    var shipmentType = shipmentDetailService.getShipmentType(from, to);
                    return shipmentDetailService.getShipments(shipmentType);
