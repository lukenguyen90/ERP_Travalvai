                            	...
                            	<div>
			                        ...
			                        <div id="myTabContent1" class="tab-content">
			                                    ...
			                                    <table id="mytable" class="table table-striped table-bordered" width="100%" datatable dt-options="showCase.dtOptions_detail_gerneral" dt-columns="showCase.dtColumns_detail_gerneral" dt-instance="showCase.dtInstance_g">
			                                    	<thead>
			                                    		<tr>
															...
															<th rowspan="2">RECOMENDED PRICE</th>
			                                    		</tr>
		                                ...
		                                <div class="tab-pane fade" id="s2">
		                                	<div class="table-responsive">
			                                    <table id="mytable_g" class="table table-striped table-bordered" width="100%" datatable dt-options="showCase.dtOptions_detail" dt-columns="showCase.dtColumns_detail" dt-instance="showCase.dtInstance">
			                                    	<thead>
			                                    		<tr>
			                                    			<th colspan="2" class="text-center">COSTING</th>
															...
															<th rowspan="2" class="text-center">FACTORY</th>
...
<script src="/includes/js/views/price-list-zone/detail_factory.js?v=#application.version#"></script>
...
<script src="/includes/js/plugin/datatables/button/dataTables.buttons.min.js"></script>
<script src="/includes/js/plugin/datatables/button/buttons.bootstrap.min.js"></script>

<script src="/includes/js/plugin/datatables/button/pdfmake.min.js"></script>
<script src="/includes/js/plugin/datatables/button/vfs_fonts.js"></script>
<script src="/includes/js/plugin/datatables/button/jszip.min.js"></script>
<script src="/includes/js/plugin/datatables/button/buttons.flash.min.js"></script>
<script src="/includes/js/plugin/datatables/button/buttons.html5.min.js"></script>
<script src="/includes/js/plugin/datatables/button/buttons.print.min.js"></script>
<script src="/includes/js/plugin/datatables/button/buttons.custom.js"></script>
