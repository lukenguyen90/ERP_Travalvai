<section id="widget-grid" class="" ng-app="typeCustomer" ng-controller="BindAngularDirectiveCtrl as showCase">
    <!-- row -->
    <div class="row">
        <!-- NEW WIDGET START -->
...
<script src="/includes/js/views/type_customer.list.js?v=#application.version#"></script>
</cfoutput>