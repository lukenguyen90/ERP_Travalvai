			                        ...
			                        <div id="myTabContent1" class="tab-content">
			                        	<div class="tab-pane fade in active" id="s1">
		                                	<div class="table-responsive">
			                                    <table id="mytable" class="table table-striped table-bordered" width="100%" datatable dt-options="showCase.dtOptions_detail_gerneral" dt-columns="showCase.dtColumns_detail" dt-instance="showCase.dtInstance">
			                                    	<thead>
			                                    		<tr>
...
<script src="/includes/js/views/price_list_zone_detail.js?v=#application.version#"></script>
