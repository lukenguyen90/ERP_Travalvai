<section id="widget-grid" class="" ng-app="roles"  ng-controller="BindAngularDirectiveCtrl as showCase">
    <div class="row">
                                            ...
                                            <div class="fcontent">
                                                <form class="form-horizontal" name="userForm" ng-submit="showCase.submitForm()" novalidate>
                                                    ...
                                                    <div class="form-group" ng-class="{'has-error' : userForm.role.$invalid && !userForm.role.$pristine}">
                                                        <label class="col-md-2 control-label text-left"><b>Role</b></label>
                                                        <div class="col-md-10">
                                                            <input class="form-control" placeholder="" type="text" name="role" id="role" ng-model="showCase.user.role" required>
                                                            <p ng-show="userForm.role.$error.required && !userForm.role.$pristine" class="help-block">Role is required</p>
                                                            <p ng-show="userForm.role.$error.pattern  && !userForm.role.$pristine" class="help-block">Can not enter special char</p>
                                                        </div>
                                                    </div>
...
<script src="/includes/js/views/roles.js"></script>
