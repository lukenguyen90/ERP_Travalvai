                    ...
                    <div class="widget-body">
                        <div class="row">
                                            ...
                                            <div class="fcontent">
                                                <form class="form-horizontal" name="userForm" ng-submit="showCase.submitForm()" novalidate>
                                                    ...
                                                    <div class="form-group" ng-class="{'has-error' : userForm.code.$invalid && !userForm.code.$pristine}">
                                                        <label class="col-md-3 control-label text-left"><strong>Code</strong></label>
                                                        <div class="col-md-9">
                                                            <input style="width: 217px;" class="form-control" type="text" name="code" id="code" ng-model="showCase.user.code" ng-pattern="showCase.regex"  required>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-3 control-label text-left"><strong>Group Product</strong></label>
                                                        <div class="col-md-9">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-6 control-label text-left"><strong>Description</strong></label>
                            ...
                            <div class="row width-table-content">
                                <fieldset>
                                    <legend class="fcollapsible col-md-10">Type of Product</legend>
...
<cfoutput>
    ...
    <script src="/includes/js/views/product.type.js?v=#application.version#"></script>
</cfoutput>