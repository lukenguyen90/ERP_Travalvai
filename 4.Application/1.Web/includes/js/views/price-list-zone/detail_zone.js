	    ...
	    $("#plf_code").change(function(){
      	...
      	vm.dtOptions_detail  = DTOptionsBuilder.fromSource('/index.cfm/price_list_zone_detail/getPLZ_details?id_plz=' + getQueryVariable('id'))
          	...
          	.withLightColumnFilter({
	            '0' : {type : 'text'},'1' : {type : 'text'},'2' : {type : 'text'},'3' : {type : 'text'},'4' : {type : 'text'},
	            '5' : {type : 'text'},'6' : {type : 'text'},'7' : {type : 'text'},'8' : {type : 'text'},
	            '9' : {type : 'text'},'10' : {type : 'text'},'11' : {type : 'text'},'12' : {type : 'text'},
	            '13' : {type : 'text'},'14' : {type : 'text'},'15' : {type : 'text'}
	        })
